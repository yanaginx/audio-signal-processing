...
def plotSpectogramF0Segments(x, fs, w, N, H, f0, segments):
    ...
    # using same params as used for analysis
    ...
    for ii in range(segments.shape[0]):
        plt.plot(timeStamps[segments[ii, 0]:segments[ii, 1]],
                 f0[segments[ii, 0]:segments[ii, 1]], color='#A9E2F3', linewidth=1.5)
...
# test = load(2, 2)
# print(test)
# res = segmentStableNotesRegions(**test['input'])
# print(res)
